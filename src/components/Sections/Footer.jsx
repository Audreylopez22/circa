    ...
    <Box sx={{ width: "100%", backgroundColor: "white", py: 3 }}>
      ...
      >
        ...
        >
          {!isSmallScreen && (
            <Typography variant="h4" sx={{ color: "black", fontWeight: "bold" }}>
              Conectar y transformar la vida de las personas al rededor de una
              tasa de café.
            </Typography>
          )}
          {isSmallScreen && (
        ...
        >
          ...
          <Typography
            variant="body1"
            sx={{ color: "black", mt: isSmallScreen ? 2 : 3,mr: isSmallScreen ? 0 : 5, textAlign: isSmallScreen ? "center" : "right" }}
          >
